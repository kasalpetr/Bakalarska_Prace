...
int EdgeDetector::findClosestShapeId(const cv::Point &point, const std::vector<Shape> &shapes, int excludedShapeId) const // function finds the closest shape ID
{
...
double EdgeDetector::pointToShapeDistance(const cv::Point &point, const Shape &shape) const // function calculates the distance from a point to the closest edge of a shape
{
...
double EdgeDetector::computeEndpointDistance(const Edge &a, const Edge &b) const // function computes the distance between the endpoints of two edges
{
...
void EdgeDetector::drawDetectedEdges(cv::Mat &image, const std::vector<Edge> &edges) const // function draws the detected edges on the image
{
