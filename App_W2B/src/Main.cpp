...
int main(int argc, char *argv[])
{
    ...
    // cv::Mat image = ImageLoader::loadImage((appRoot / "Img" / "Table.jpg").string(), (appRoot / "json" / "imageConfig.json").string()); // Load the image
    ...
    // cv::Mat image = ImageLoader::loadImage((appRoot / "Img" / "TestError.jpg").string(), (appRoot / "json" / "imageConfig.json").string()); // Load the image 
